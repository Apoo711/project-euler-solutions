...
- I knew the answer must be a multiple of the smallest multiple for 1 through 10, which is 2520. By incrementing the `counter` by 2520 in each step, I skipped thousands of unnecessary checks.
...
- The code calculated the LCM of 1 and 2, then the LCM of that result and 2, and so on, all the way up to 20.
